vercelError დაჰოსტილი გვერდი არ მუშაობს ფუნქციონალის მიხედვით, არ არენდერებს ErrorPages, არასწორად არენდეერებს gallery-ს და Profile/person --> made by (someone)
